	...
	public static final class Builder implements org.apache.logging.log4j.core.util.Builder<SpringProfileArbiter> {
		...
		@Nullable @Override
  		public SpringProfileArbiter build() {
  			...
  			org.apache.logging.log4j.core.config.Configuration localConfiguration = this.configuration;
  			if (localConfiguration == null) {
  				statusLogger.warn("Cannot create Arbiter, no Configuration available");
  				return null;
  			}
  			String name = localConfiguration.getStrSubstitutor().replace(this.name);
